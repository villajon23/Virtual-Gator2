...
def classifyPose(landmarks, output_image, display=False):
    ...
    if (right_knee_angle > 60 and right_knee_angle < 80 and right_elbow_angle > 220 and right_elbow_angle < 260) \
        or (left_knee_angle > 175 and left_knee_angle < 292 and left_elbow_angle > 105 and left_elbow_angle < 269):
        #print('R_knee', right_knee_angle, 'R_elbow', right_elbow_angle)


        if (right_shoulder_angle > 50 and right_shoulder_angle < 80) or (left_shoulder_angle > 22 and left_shoulder_angle < 305):
