...
def classifyPose(landmarks, output_image, display=False):
    ...
    if ((left_knee_angle > 20 and left_knee_angle < 90) and (right_knee_angle > 65 and right_knee_angle < 100)) or \
        ((left_knee_angle > 265 and left_knee_angle < 305) and (right_knee_angle > 255 and right_knee_angle < 285)):
        #print('R_knee', right_knee_angle, 'R_elbow', right_elbow_angle)
        

        #check elbows
        if ((left_elbow_angle > 240 and left_elbow_angle < 340) and (right_elbow_angle > 240 and right_elbow_angle < 340)) or \
            ((left_elbow_angle > 25 and left_elbow_angle < 80) or (right_elbow_angle > 25 and right_elbow_angle < 80)):
...
camera_video = cv2.VideoCapture('PoseVideos/c1_v1_s.mp4')
