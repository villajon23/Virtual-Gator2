...
class PoseDetector:
    ...
    def findAngle(self, img, p1, p2, p3, draw=True):
        ...
        # Get the landmarks, slice from point 1 to end
        ...
        if angle < 0:   #handle negatives by adding 360
            angle += 360

        # Draw
        if draw:
            cv2.line(img, (x1, y1), (x2, y2), (50, 205, 50), 3)
            cv2.line(img, (x3, y3), (x2, y2), (50, 205, 50), 3)
